...
export default class BlogForm extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            content: "",
            featured_image: "",
            apiUrl: "https://odayafrauendorff.devcamp.space/portfolio/portfolio_blogs", 
            apiAction: "post"
        };
    ...
    componentWillMount() {
        if (this.props.editMode) {
            this.setState({
                ...
                apiUrl: `https://odayafrauendorff.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`, 
                apiAction: "patch"
            });
        }
    }
...
//         axios
//             .post(
//                 "https://odayafrauendorff.devcamp.space/portfolio/portfolio_blogs", 
//                 this.buildForm(), 
//                 { withCredentials: true }
//             )
//             .then(response => {
